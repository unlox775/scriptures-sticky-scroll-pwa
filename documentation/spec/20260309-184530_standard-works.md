# Standard Works — Iteration Log

**Prompt slug:** `standard-works`  
**Last updated:** 2026-03-09 19:00 UTC

This living spec rolls up every instruction and deliverable from the Scripture Reader PWA effort. See `20260309-184530_standard-works-PROMPT.txt` for the full prompt history (chronological, earliest-first).
...
1. Polish mobile UX and long-session performance — iterate in `20260309-210000_pivot-*`.

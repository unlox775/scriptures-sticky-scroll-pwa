# Scripture PWA Pivot — Iteration Log (SUPERSEDED)

**Prompt slug:** `scripture-pwa-pivot`  
**Last updated:** 2026-05-13  
**Status:** Superseded for scroller work. This spec now covers the pre-scroller pivot/refactor setup only. The infinite-scroller rewrite and production reader transplant live in `20260512-224600_scripture-pwa-infinite-scroller-*`.

See `20260309-210000_scripture-pwa-pivot-PROMPT.txt` for the remaining pre-scroller prompt history.
...
Prompt 12 began the new infinite-scroller rewrite. Continue that work in `20260512-224600_scripture-pwa-infinite-scroller-*`.
